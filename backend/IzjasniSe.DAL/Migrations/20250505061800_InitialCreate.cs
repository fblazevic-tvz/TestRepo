        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmissionStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SubmissionEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proposals_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_Users_ModeratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notices_Proposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "Proposals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notices_Users_ModeratorId",
                        column: x => x.ModeratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Suggestions_Proposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "Proposals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Suggestions_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Votes", x => new { x.UserId, x.SuggestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notices_ModeratorId",
                table: "Notices",
                column: "ModeratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Notices_ProposalId",
                table: "Notices",
                column: "ProposalId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposals_CityId",
                table: "Proposals",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposals_ModeratorId",
                table: "Proposals",
                column: "ModeratorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suggestions_ProposalId",
                table: "Suggestions",
                column: "ProposalId");
