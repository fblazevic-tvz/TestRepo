...
namespace IzjasniSe.Api.Controllers
{
    ...
    public class ProposalAttachmentsController : ControllerBase
    {
        private readonly IProposalAttachmentService _attachmentService;
        private readonly IProposalService _proposalService;
        private readonly ILoggedInService _loggedInService;
        private readonly IWebHostEnvironment _environment;
        private readonly IContentTypeProvider _contentTypeProvider;
        private readonly ILogger<ProposalAttachmentsController> _logger;

        public ProposalAttachmentsController(
            IProposalAttachmentService attachmentService,
            IProposalService proposalService,
            ILoggedInService loggedInService,
            IWebHostEnvironment environment,
            ILogger<ProposalAttachmentsController> logger)
        {
        ...
        public async Task<ActionResult<IEnumerable<AttachmentDto>>> GetByProposalId(int proposalId)
        {
            var attachments = await _attachmentService.GetByProposalIdAsync(proposalId);
            ...
            var dtos = attachments.Select(a => new AttachmentDto
            {
                ...
                DownloadUrl = $"{Request.Scheme}://{Request.Host}/api/proposalattachments/{a.Id}/download",
        ...
        public async Task<ActionResult<AttachmentDto>> GetById(int id)
        {
            ...
            var dto = new AttachmentDto
            {
                ...
                DownloadUrl = $"{Request.Scheme}://{Request.Host}/api/proposalattachments/{attachment.Id}/download",
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            // Check authorization
            var proposal = await _proposalService.GetByIdAsync(attachment.ProposalId);
            if (proposal == null)
                return NotFound();
